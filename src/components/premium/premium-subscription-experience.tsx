...
export function PremiumSubscriptionExperience() {
  return (
    <>
      <section id="vision" className="section-wrap pt-4 md:pt-8">
        <div className="relative overflow-hidden rounded-[40px] border border-[#d8ccff] bg-[#140b30] text-white shadow-[0_45px_110px_-70px_rgba(40,24,101,0.72)]">
          ...
          <div className="relative px-5 py-10 sm:px-6 md:px-10 md:py-16 lg:px-14 lg:py-20">
            <div className="max-w-[48rem]">
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-white/62">
                Rooted tradition. Built for the future.
              </p>

              <h1 className="mt-5 font-display text-[clamp(2.75rem,9vw,7rem)] font-semibold leading-[0.92] text-white sm:mt-6">
                Build Your Future,
                <br />
              ...
              <div className="mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:flex-wrap">
                <a
                  className="subtle-focus-ring inline-flex h-12 items-center justify-center gap-2 rounded-full bg-accent px-7 text-sm font-semibold text-[var(--accent-ink)] transition hover:bg-accent-strong"
                ...
                <a
                  className="subtle-focus-ring inline-flex h-12 items-center justify-center gap-2 rounded-full border border-white/18 bg-white/8 px-6 text-sm font-semibold text-white transition hover:bg-white/12"
                  href="#app-preview"
                >
      ...
      <section id="community" className="section-wrap py-16 md:py-20">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div className="px-1 md:px-4">
            ...
            <h2 className="mt-5 font-display text-4xl font-semibold leading-[0.98] text-foreground md:text-6xl">
            ...
            <div className="mt-8 space-y-5">
              {philosophyPoints.map((point) => (
                <div key={point.title} className="flex gap-4">
                  ...
                  <div>
                    <h3 className="flex flex-wrap items-center gap-2 font-display text-xl font-semibold text-foreground md:text-2xl">
                      {point.title}
                      {point.comingSoon ? (
          ...
          <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
            ...
            <div className="relative mx-auto w-full max-w-[560px] pb-10">
              <img
                ...
                className="ml-auto h-[260px] w-full rounded-[26px] object-cover shadow-[0_30px_60px_-42px_rgba(64,37,151,0.24)] sm:w-[86%] md:h-[360px]"
                src={serenityImage}
              />
              <div className="premium-panel absolute bottom-0 left-0 w-[85%] px-5 py-4 sm:w-[76%] sm:px-6 sm:py-5">
                <p className="font-display text-[1.25rem] italic leading-snug text-accent-strong sm:text-[1.65rem]">
      ...
      <section id="support" className="section-wrap pb-20 md:pb-24">
        <div className="surface-dark overflow-hidden px-5 py-8 sm:px-6 md:px-8 md:py-10">
