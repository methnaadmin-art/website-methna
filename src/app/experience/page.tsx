...
const flowSteps = [
  {
    ...
    description:
      "The live discovery card, top controls, and swipe actions are shown with the same light-mode rhythm as the mobile app.",
    icon: Shield,
  },
  {
      ...
      <section className="section-wrap pt-12 pb-10 md:pt-16 md:pb-14">
        <div className="overflow-hidden rounded-[8px] border border-border/70 bg-[linear-gradient(135deg,#2a1a6d_0%,#3a2492_48%,#4c20cf_100%)] px-6 py-8 text-white shadow-[0_30px_64px_-42px_rgba(45,28,112,0.34)] md:px-10 md:py-12">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-relaxed text-white/75 md:text-base">
            ...
            visual language as the live product, presented inside polished iPhone 17 Pro
      ...
      <section className="section-wrap pb-14 md:pb-20">
        <div className="premium-panel p-6 md:p-8">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <Link
              className="subtle-focus-ring inline-flex h-11 items-center gap-2 rounded-xl border border-accent/20 bg-white px-5 text-sm font-semibold text-foreground transition hover:border-accent/40 hover:bg-accent-soft/45"
              href="/contact"
            >
              Contact support
            </Link>
